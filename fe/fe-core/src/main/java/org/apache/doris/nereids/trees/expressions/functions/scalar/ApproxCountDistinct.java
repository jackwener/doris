...
/**
 * ScalarFunction 'ApproxCountDistinct'.
 */
public class ApproxCountDistinct extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            // FunctionSignature.ret(BigIntType.INSTANCE).args(CharType.INSTANCE),
    ...
    public ApproxCountDistinct(Expression arg) {
        super("approx_count_distinct", arg);
    }
